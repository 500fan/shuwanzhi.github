...
#文件的绝对路径
file_path = "E:\GitHub Desktop\GitHub\pipixia-20-1-12\img\\"
#CDN前缀
web_path = "https://cdn.jsdelivr.net/gh/"
#GITHUB账户名
user_path = "anderson-ryen"
#仓库名
warehouse_path = "pipixia-20-1-12"
#仓库内文件夹
img_path = "img"
#合并path
...
print("")
print("=" *50)
print("pipixia-20-1-12已完成")
print("=" *50)
print("")

if __name__ == '__main__':
    filelist = os.listdir(file_path)
    with open(r"E:\GitHub Desktop\GitHub\Pictruebed-API\php-api\pipixia-20-1-12.txt",'w') as f:
